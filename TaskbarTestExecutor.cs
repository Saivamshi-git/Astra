...
namespace DesktopElementInspector
{
    ...
    /// </summary>
    public static class TaskbarTestExecutor
    {
        /// <summary>
        ...
        public static void RunInteractiveTest()
        {
            ...
            for (int i = 0; i < scrapedElements.Count; i++)
            {
                ...
                Console.WriteLine($"  [{i}] ID: {element.TbId}, Name: {element.Name}");
            }
            ...
            while (true)
            {
                ...
                bool success = taskbarScraper.ExecuteClick(selectedElement.TbId, selectedElement.Name);
